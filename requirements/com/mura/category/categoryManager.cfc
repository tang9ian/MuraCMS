...
<cffunction name="save" access="public" returntype="any" output="false">
	...
	<cfif isObject(arguments.data)>
		...
		<cfelse>
			<cfthrow type="custom" message="The attribute 'DATA' is not of type 'com.mura.category.categoryBean'">
		</cfif>
	</cfif>
...
<cffunction name="delete" access="public" returntype="void" output="false">
	...
	<cfset pluginEvent=createObject("component","com.mura.event").init(pluginStruct)>
