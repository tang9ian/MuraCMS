...
<cffunction name="save" access="public" returntype="any" output="false">
	...
	<cfif isObject(arguments.data)>
		...
		<cfelse>
			<cfthrow type="custom" message="The attribute 'DATA' is not of type 'com.mura.user.userBean'">
		</cfif>
	</cfif>	
...
<cffunction name="getUserFeedBean" returntype="any" output="false">
	<cfset var userFeedBean=createObject("component","com.mura.user.userFeedBean").init()>
