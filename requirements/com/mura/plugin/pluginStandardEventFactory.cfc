...
--->
<cfcomponent extends="com.mura.Factory" output="false">
...
<cffunction name="get" access="public" returntype="any" output="false">
		...
		<cfelse>
			...
			<cfif structKeyExists(variables.standardEventsHandler,localKey)>
				...
				<cfset super.set( localKey, wrappedClassInstance )>
			<cfelse>
				<cfset wrappedClassInstance=wrapHandler(createObject("component","com.mura.Translator.#localKey#").init(),localKey)>
			</cfif>
			<!---<cfif arguments.persist>
				<cfset super.set( localKey, wrappedClassInstance )>
			</cfif>--->
...
<cfreturn createObject("component","com.mura.plugin.pluginStandardEventWrapper").init(arguments.handler,arguments.eventName)>
</cffunction>
