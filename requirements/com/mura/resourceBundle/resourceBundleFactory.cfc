...
<cfargument name="locale"  type="string" required="true" default="#variables.locale#">
	...
	<cfif not structKeyExists(variables.resourceBundles,"#arguments.locale#")>
		<cfset variables.resourceBundles["#arguments.locale#"]=createObject("component","com.mura.resourceBundle.resourceBundle").init(arguments.locale,variables.resourceDirectory) />
	</cfif>	
