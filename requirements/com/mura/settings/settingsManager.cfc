...
<cffunction name="update" access="public" output="false" returntype="any">
	...
	<cfset var pluginEvent = createObject("component","com.mura.event").init(arguments.data) />
...
<cfargument name="formDataMode" default="none">
	...
	<cfset var keyFactory		= createObject("component","com.mura.publisherKeys").init(arguments.keyMode,application.utility)>
...
<cffunction name="isBundle" output="false">
	<cfargument name="BundleFile">
	<cfset var rs=createObject("component","com.mura.Zip").List(zipFilePath="#arguments.BundleFile#")>
...
<cffunction name="createCacheFactory" output="false">
	...
	<cfif not arguments.capacity>
		<cfreturn createObject("component","com.mura.cache.cacheFactory").init(freeMemoryThreshold=arguments.freeMemoryThreshold)>
	<cfelse>
		<cfreturn createObject("component","com.mura.cache.cacheFactoryLRU").init(capacity=arguments.capacity, freeMemoryThreshold=arguments.freeMemoryThreshold)>
	</cfif>
...
<cffunction name="save" access="public" returntype="any" output="false">
	...
	<cfif isObject(arguments.data)>
		...
		<cfelse>
			<cfthrow type="custom" message="The attribute 'DATA' is not of type 'com.mura.settings.settingsBean'">
		</cfif>
	</cfif>
