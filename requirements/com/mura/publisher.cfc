...
<cfcomponent extends="com.mura.cfobject" output="false">
	...
	<cffunction name="getToWork" returntype="any" output="false">
		...
		<cfif not structKeyExists(arguments,"keyFactory")>
			<cfset arguments.keyFactory=createObject("component" ,"com.mura.publisherKeys").init(arguments.keyMode,application.utility)>
		</cfif>
	...
	<cffunction name="publish" returntype="void">
		...
		<cfset var pluginEvent = createObject("component","com.mura.event").init(arguments) />
		<cfset var keys=createObject("component","com.mura.publisherKeys").init('publish',application.utility)>
	...
	<cffunction name="copy" returntype="void" output="no">
		...
		<cfset keys=createObject("component","com.mura.publisherKeys").init('copy',application.utility)>
