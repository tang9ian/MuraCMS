...
--->
<cfcomponent output="false" extends="com.mura.cfobject">
	...
	<cffunction name="init" access="public" returntype="com.mura.Factory" output="false">
	...
	<cffunction name="setParent" access="public" returntype="void" output="false">
		<cfargument name="parent" type="com.mura.Factory" required="true" />
		<cfset variables.parent = arguments.parent />
	</cffunction>
	
	<cffunction name="getParent" access="public" returntype="com.mura.Factory" output="false">
