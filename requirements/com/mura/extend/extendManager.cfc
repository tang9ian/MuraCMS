...
<cfset var subtype=createObject("component","com.mura.extend.extendSubType").init(variables.configBean) />
<cfreturn subtype />
</cffunction>
...
<cffunction name="getExtendedData" access="public" returntype="any">
	...
	<cfif structKeyExists(arguments,"type") and  structKeyExists(arguments,"subtype") and  structKeyExists(arguments,"siteID")>
		<cfreturn createObject("component","com.mura.extend.extendData").init(
