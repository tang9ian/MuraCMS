...
<cfset var attribute = createObject("component","com.mura.extend.extendAttribute").init(variables.configBean,variables.contentRenderer) />
...
<cffunction name="loadAttributes" access="public">
	...
	<cfif rsAttributes.recordcount>
		...
		<cfset tempArray=createObject("component","com.mura.queryTool").init(rsAttributes).toArray() />
		
		<cfloop from="1" to="#rsAttributes.recordcount#" index="a">
			<cfset attribute=createObject("component","com.mura.extend.extendAttribute").init(variables.configBean,variables.contentRenderer) />
