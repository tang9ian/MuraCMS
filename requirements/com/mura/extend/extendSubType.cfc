...
<cfset var extendSetBean=createObject("component","com.mura.extend.extendSet").init(variables.configBean,getContentRenderer()) />
...
<cfset var s=0/>
	...
	<cfif rsSets.recordcount>
		<cfset tempArray=createObject("component","com.mura.queryTool").init(rsSets).toArray() />
