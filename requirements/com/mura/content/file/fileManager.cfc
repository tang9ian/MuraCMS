...
<cfargument name="method" type="string" required="true" default="inline">
	...
	<cfset var pluginEvent = createObject("component","com.mura.event") />
	<cfset var fileCheck="" />
		...
		<cfswitch expression="#variables.configBean.getFileStore()#">	
			<cfcase value="database">
				...
				<cfif variables.configBean.getCompiler() neq 'Railo'>
					<cfset createObject("component","com.mura.content.file.renderAdobe").init("#rsfileData.contentType#/#rsfileData.contentSubType#",rsFileData.image)>
				<cfelse>
					<cfset createObject("component","com.mura.content.file.renderRailo").init("#rsfileData.contentType#/#rsfileData.contentSubType#",rsFileData.image)>
				</cfif>
	...
	<cfif not isValid("UUID",arguments.fileID)>
		...
		<cfswitch expression="#variables.configBean.getFileStore()#">	
			<cfcase value="database">
				...
				<cfif variables.configBean.getCompiler() neq 'Railo'>
					<cfset createObject("component","com.mura.content.file.renderAdobe").init("#rsfile.contentType#/#rsfile.contentSubType#",rsFile.imageSmall)>
				<cfelse>
					<cfset createObject("component","com.mura.content.file.renderRailo").init("#rsfile.contentType#/#rsfile.contentSubType#",rsFile.imageSmall)>
				</cfif>
			</cfcase>
			<cfcase value="filedir">
	...
	<cfif not isValid("UUID",arguments.fileID)>
		...
		<cfswitch expression="#variables.configBean.getFileStore()#">	
			<cfcase value="database">
				...
				<cfif variables.configBean.getCompiler() neq 'Railo'>
					<cfset createObject("component","com.mura.content.file.renderAdobe").init("#rsfile.contentType#/#rsfile.contentSubType#",rsFile.imageMedium)>
				<cfelse>
					<cfset createObject("component","com.mura.content.file.renderRailo").init("#rsfile.contentType#/#rsfile.contentSubType#",rsFile.imageMedium)>
				</cfif>
			</cfcase>
			<cfcase value="filedir">
				<cfset rsFile=readMeta(arguments.fileid) />
...
<cfswitch expression="#variables.configBean.getCompiler()#">
	<cfcase value="railo">
		<cfset createObject("component","com.mura.content.file.renderRailo").init(arguments.mimeType,arguments.file) />
	</cfcase>
	<cfdefaultcase>
		<cfset createObject("component","com.mura.content.file.renderAdobe").init(arguments.mimeType,arguments.file) />
	</cfdefaultcase>
</cfswitch>
</cffunction>
...
<cffunction name="renderS3" output="true" access="public" returntype="any">
	...
	<cfif structKeyExists(local.theFile, "fileContent") and isArray(local.theFile.fileContent)>
		...
		<cfif structKeyExists(local.rsFile, "contentType") and structKeyExists(local.rsFile, "contentSubType")>
			<cfif variables.configBean.getCompiler() neq "Railo">
				<cfset createObject("component","com.mura.content.file.renderAdobe").init("#local.rsFile.contentType#/#local.rsFile.contentSubType#",local.theFile.fileContent) />
			<cfelse>
				<cfset createObject("component","com.mura.content.file.renderRailo").init("#local.rsFile.contentType#/#local.rsFile.contentSubType#",local.theFile.fileContent) />
			</cfif>
		</cfif>
	</cfif>	
</cffunction>
