...
<cfcomponent extends="com.mura.cfobject" output="false">
	...
	<cffunction name="add" access="public" returntype="any" output="false">
		...
		<cfset var i = "" />
		<cfset var d = "" />
		<cfset var pluginEvent = createObject("component","com.mura.MuraScope") />
		<cfset var tempFile="" />
		...
		<cfif isObject(arguments.data)>
			...
			<cfelse>
				<cfthrow type="custom" message="The attribute 'DATA' is not of type 'com.mura.content.contentBean'.">
			</cfif>
		</cfif>
	...
	<cffunction name="traverseSite">
		...
		<cfloop query="rs">
			...
			<cfelse>
				...
				<cfset servlet=createObject("component","com.mura.servlet").init()/>
